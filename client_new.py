...
# model = load_model()
# model.load_weights('./melamodel/melamodel_weights094.h5')
...
# fl.client.start_numpy_client("[::]:8080", FlowerClient())

def main() -> None:
    parser = argparse.ArgumentParser(description="Flower")
    parser.add_argument("--path", type=str, default="./isicdata/datasets/doctor_case.csv", help="Path to the dataset")
